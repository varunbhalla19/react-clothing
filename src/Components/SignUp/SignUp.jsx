        ...
        return (
            <div className="sign-up">
                ...
                <form className="sign-up-form"
                    ...
                    <FormInput
                        type="text"
                        name="name" id="su-name" label="Name"
                        value={this.state.name} required={true}
                        onChange={this.handleChange} />
                    <FormInput
                        type="email"
                        name="email" id="su-email" label="E-mail"
                        value={this.state.email} required={true}
                        onChange={this.handleChange} />
                    <FormInput
                        type="password"
                        name="password" id="su-pass" label="Password"
                        value={this.state.password} required={true}
                        onChange={this.handleChange} />
                    <FormInput
                        type="password"
                        name="confirmPass" id="su-confpass" label="Confirm Password"
                        value={this.state.confirmPass} required={true}
                        onChange={this.handleChange} />
